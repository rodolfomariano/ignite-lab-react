...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string, id: string, title: string, availableAt?: any | null, lessonType: LessonType }> };
